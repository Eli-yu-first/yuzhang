...
<div class="p-4" style="background-image: linear-gradient(220.55deg, rgba(255, 246, 235, 0.035), rgba(223, 209, 197, 0.035));">
    ...
    <section style="text-align: justify;">
        <p>
        <h6 style="border-left: 3px solid #5b8dee; padding-left: 8px; margin-bottom: 8px;">
            <i class="fa-solid fa-user" style="color: #5b8dee;"></i> My Description
        </h6>
    ...
    <section style="text-align: justify;">
        <h6 style="border-left: 3px solid #20c997; padding-left: 8px; margin-bottom: 8px;">
            <i class="fa-solid fa-microscope" style="color: #20c997;"></i> Research and Leadership Experience
        </h6>
        <p>
    ...
    <section style="text-align: justify;">
        <h6 style="border-left: 3px solid #fd7e14; padding-left: 8px; margin-bottom: 8px;">
            <i class="fa-solid fa-rocket" style="color: #fd7e14;"></i> Future Goals
        </h6>
        <p>
